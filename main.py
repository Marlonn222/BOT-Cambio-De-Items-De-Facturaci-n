# Codigo Principal Del Boot De Cambio de Items
...
async def main():   
    ...
    # CONSTANTS
    TELEGRAM_CHAT_ID = 
    INPUT_DIRECTORY = 'C:\Cambio de Items\Insumos'
    INPUT_FILENAME = 'Input BOT 001 V1.xlsx'
    SUPER_LOG_FILENAME = 'C:/Cambio de Items/logs/super_log.txt'
    ...
    try:
        ...
        for row in rows:
            ...
            if actividad_rpa.lower() == "1":   
                ...
                resp_funcion = searchOTHControl(str(row[0].value))
